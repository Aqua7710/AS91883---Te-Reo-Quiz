class MaoriQuiz
{
    public static void Main()
    {
        int selection;
        //introduction 
        Console.WriteLine("Kia Ora user! Welcome to this Te Reo Māori quiz.\nThis quiz will test your Te Reo Māori knowlege by asking you 10 multichoice questions. You will only have one try to get the question right. After you answer these questions, the program will calculate and display your skill level.");
        //quiz level selector
        Console.WriteLine("\n\nDifficulty level:\n\n1 = Beginner" + "\n\n2 = Intermediate" + "\n\n3 = Advanced");
        ...
        if (selection == 1)
        {
            BeginnerLevel(); // method for beginner quiz level
        }
        else if (selection == 2)
        {
            IntermediateLevel(); // method for intermediate quiz level
        }
        else
        {
            AdvancedLevel(); // method for advanced quiz level
        }
    }
    ...
    public static void BeginnerLevel()
    {
        ...
        Console.WriteLine("You selected the Beginner quiz! Begin answering the questions.\n\n");

        // question 1, beginner
        Console.WriteLine("Score = " + score);
        Console.WriteLine("\n\nQuestion 1) How do you say 'Hello' in Māori?");
        Console.WriteLine("\n\n1 = kia ngahau" + "\n\n2 = whakakatakata" + "\n\n3 = Kia Ora" + "\n\n4 = po pai");
        ...
        Console.WriteLine("\n\n\nCongratulations! You have completed the Te Reo Māori quiz!");
        if (score <= 3)
        {
    ...
    {
        int intermediateQuiz, score = 0;
        string I = "Incorrect", C = "Correct!";
        Console.Clear();
        Console.WriteLine("You selected the Intermediate quiz! Begin answering the questions.\n\n");

        // question 1, intermediate
        Console.WriteLine("Score = " + score);
        Console.WriteLine("\n\nQuestion 1) How do you say 'ocean' in Māori?");
        Console.WriteLine("\n\n1 = whenua" + "\n\n2 = rakau" + "\n\n3 = moana" + "\n\n4 = rangi");
        Console.Write("\nYour answer (select an answer by typing the number next to the option you pick and then press enter) = ");
    ...
    {
        int advancedQuiz, score = 0;
        string I = "Incorrect", C = "Correct!";

        Console.Clear(); // clears all the text that came before so that it's easier to focus
        Console.WriteLine("You selected the Advanced quiz! Begin answering the questions.\n\n");

        // question 1, advanced
        Console.WriteLine("Score = " + score);
        Console.WriteLine("\n\nQuestion 1) Which one is 'please and thank you' in Māori?");
        Console.WriteLine("\n\n1 = tēnā koa" + "\n\n2 = tēnā koe, tēnā koe" + "\n\n3 = tēnā koa, tēnā koa" + "\n\n4 = pouri");
        Console.Write("\nYour answer (select an answer by typing the number next to the option you pick and then press enter) = ");
    ...
    public static void EndMethod()
    {
        ...
        switch (reDo)
        {
            case 1:
                Console.Clear();
                Main(); // will take user back to the introductuion method
                break;

            default:
                Console.WriteLine("\n\nThank you for participating!"); // end message
                break;
        }
    }
}