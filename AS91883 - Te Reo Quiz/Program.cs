class MaoriQuiz
{
    ...
    {
        int beginnerQuiz, score = 0, reDo;
    // variable for beginner quiz, variable used to keep track of the score, starts at 0 and then for every correct user input for the question, it will add 1, and the redo variable for user to select 1 or 2 at the end of each quiz to decide what to do next             
    string I = "Incorrect", C = "Correct!", endMessage = "\n\n\nThank you for particapating in this quiz! Press any key to exit.\n\n-------------------------------------------------------------"; // string variables to display if the users answer is correct or incorrect, more efficent than writing correct or incorrect every time
        ...
        switch (reDo)
        {
            case 1:
                Console.Clear();
                Main(); // allows user to redo the quiz or pick another quiz, it will take them back to the introduction method
                break;
    ...
    {
        int intermediateQuiz, score = 0, reDo;
        string I = "Incorrect", C = "Correct!", endMessage = "\n\n\nThank you for particapating in this quiz! Press any key to exit.\n\n-------------------------------------------------------------"; // string variables to display if the users answer is correct or incorrect, more efficent than writing correct or incorrect every time
                                                                                                                                                                                                        // intermediate quiz
        Console.Clear();
        ...
        switch (reDo)
        {
            case 1:
                Console.Clear();
                Main(); // will take user back to the main method
                break;
